...
function buildMusic() {
  $('#app').empty();
  buildBackButton();
  const guitar = new ImageElementWidget(10, 100, 200, 327, 0, 'assets/example-music/guitar.png', 'B3', 'C9', '38', '');
  $('#app').append(guitar.domElem);
  const piano = new ImageElementWidget(450, 100, 200, 205, 0, 'assets/example-music/piano.png', 'B3', 'C9', '38', '');
  $('#app').append(piano.domElem);
  const saxophone = new ImageElementWidget(800, 100, 100, 228, 0, 'assets/example-music/saxophone.png', 'B3', 'C9', '38', '');
